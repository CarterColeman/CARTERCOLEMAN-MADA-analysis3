...
#Use workflow to fit the model to the train data set
...
#Using augment() function to predict outcomes in the test data.
...
```
#Model with just the main predictor: Runnynose
...
# Looking at the output, the model with all the predictor is better than model with just runny nose as a predcitor