...
_The resulting ROC_AUC values were 0.30 and 0.21 for the test data model and the training data model, respectively. This suggests that the models were not a good fit to predict outcomes for the data._
...
_The resulting ROC_AUC values were 0.25 and 0.23 for the test data model and the training data model, respectively. This suggests that the models were not a good fit to predict outcomes for the data._
